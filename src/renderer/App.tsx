...
export function App(): ReactElement {
  ...
  const winamaxAutoImportStatus = useWinamaxAutoImport(accessStatus.access?.canImport === true, bankroll.refresh);
